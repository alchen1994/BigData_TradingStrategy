...
#
                    ...
                    if lastClose > 0 and close > 0 and lastVolume > 0:
                        ...
                        data.append([open_, high_, low_, close_, volume_, trading_price])
    ...
    def _step(self, action):
        ...
        if self.actions[action] == "Buy":
            ...
            self.reward = (self.current_asset_value - self.last_asset_value) + price_change * trading_amount  - self.current_asset['stock']
            #10
